...
Usage:
    python data/d3/load_d3.py [options]
...
Examples:
    ...
    python data/d3/load_d3.py --ids_csv data/d3/custom_ids.csv --save_directory /path/to/d3_images/
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ids_csv', type=Path, default=config.DATA_DIR / "d3" / "7k_sample.csv",
                        help=f"Path to CSV file containing image IDs. Default: data/d3/7k_sample.csv")
    parser.add_argument('--id_column', type=str, default='id',
                        help="Name of the column containing image IDs in the CSV file. Default: 'id'")
    parser.add_argument('--save_directory', type=Path, default=config.DATA_DIR / "d3" / "images",
                        help=f"Directory where downloaded images will be saved. Default: data/d3/images/")
